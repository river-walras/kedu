# coding: utf-8
# Vendored from jqdatasdk.finance_tables (逐字 copy, 仅 declarative_base import 改为兼容写法).
# 列名/列序/doc 必须与聚宽逻辑表一致 —— 本地 ClickHouse DDL 与逐字段比对都锚在此。
from sqlalchemy import Column, Date, DateTime, Float, Index, Integer, String, text  # noqa: F401
try:
